...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB9     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = MCU_LCD_SCL_Pin|MCU_LCD_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(MCU_LCD_SCL_GPIO_Port, MCU_LCD_SCL_Pin);

    HAL_GPIO_DeInit(MCU_LCD_SDA_GPIO_Port, MCU_LCD_SDA_Pin);
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLLSAI.PLLSAIN = 243;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    PB11     ------> LTDC_G5
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_5|GPIO_PIN_10|GPIO_PIN_11);
    ...
    HAL_GPIO_DeInit(GPIOI, GPIO_PIN_12|GPIO_PIN_11|GPIO_PIN_13|GPIO_PIN_15
                          |GPIO_PIN_14);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = BUZZER_ON_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(BUZZER_ON_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = LCD_ON_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(LCD_ON_PWM_GPIO_Port, &GPIO_InitStruct);
