...
void checkFlashData(void)
{
    ...
    if((((*papp_hdr) & 0xF0000000)!=0x20000000) && ((*pboot2_hdr) & 0xF0000000)!=0x20000000)
    {
    ...
    {
        printk("No valid jmp target address. set to jmp_adr<=APP_START_ADDR\r\n");
