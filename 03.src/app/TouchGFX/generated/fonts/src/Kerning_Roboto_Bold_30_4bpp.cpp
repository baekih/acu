...
KEEP extern const touchgfx::KerningNode kerning_Roboto_Bold_30_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x002C, -4 },  // (First char = [0x002C, ,], Second char = [0x0022, "], Kerning dist = -4)
    ...
    { 0x002C, -4 },  // (First char = [0x002C, ,], Second char = [0x0027, '], Kerning dist = -4)
    { 0x002E, -4 },  // (First char = [0x002E, .], Second char = [0x0027, '], Kerning dist = -4)
    ...
    { 0x002F, -4 },  // (First char = [0x002F, /], Second char = [0x002F, /], Kerning dist = -4)
