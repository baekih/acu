...
static int32_t opFastpacketBuildup(RxProtocol *prxpkt)
{
...
static int32_t opFastpktQueuePut(TxProtocol *ptxpkt, uint8_t *pfastpkt_dat, uint8_t fastdat_len_trunc)
{
...
static int32_t opChkMultiPktRunning(RxProtocol *prxpkt)
{
