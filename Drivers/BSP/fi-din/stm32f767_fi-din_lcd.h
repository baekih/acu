...
#define  LCD_PIXEL_WIDTH                ((uint16_t)640) /* LCD PIXEL WIDTH            */
#define  LCD_PIXEL_HEIGHT               ((uint16_t)480) /* LCD PIXEL HEIGHT           */

#define  LCD_HSYNC                      ((uint16_t)10)  /* Horizontal synchronization */
#define  LCD_HBP                        ((uint16_t)20)  /* Horizontal back porch      */
#define  LCD_HFP                        ((uint16_t)20)  /* Horizontal front porch     */
#define  LCD_VSYNC                      ((uint16_t)4)   /* Vertical synchronization   */
#define  LCD_VBP                        ((uint16_t)4)   /* Vertical back porch        */
#define  LCD_VFP                        ((uint16_t)10)  /* Vertical front porch       */

#define  LCD_FREQ_DIV                   5               /* LCD Frequency divider      */
...
// STM32746G_DISCOVERY_LCD_Exported_Constants STM32746G_DISCOVERY_LCD Exported Constants
